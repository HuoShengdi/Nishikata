...
/***/ function(module, exports, __webpack_require__) {
	...
	var _game_info = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerWeapon1 = function (_Weapon) {
	  ...
	  function PlayerWeapon1(player) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PlayerWeapon1).call(this, {
	      owner: player
	    }));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerWaveWeapon = function (_Weapon) {
	  ...
	  function PlayerWaveWeapon(player) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PlayerWaveWeapon).call(this, {
	      owner: player
	    }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WaveBullet = function (_Bullet) {
	  ...
	  function WaveBullet(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WaveBullet).call(this, options));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EnemyA = function (_Enemy) {
	  ...
	  function EnemyA(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EnemyA).call(this, {
	      pos: options.pos,
	      vel: [0, 75],
	      radius: 12,
	      color: '#aaaaaa'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Boss1 = function (_Enemy) {
	  ...
	  function Boss1(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Boss1).call(this, {
	      pos: options.pos,
	      vel: [0, 0],
	      radius: 20,
	      color: "#5a12b5"
	  ...
	  _createClass(Boss1, [{
	    ...
	    value: function fireBullets() {
	      ...
	      var bulletVels = [];
	      for (var i = 0; i < 8; i++) {
	        bulletVels.push(this.transform([100, 0], 45 * i + 15 * lifetime / 500));
	      }
	    ...
	    key: "transform",
	    value: function transform(vel, angle) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _health_bar = __webpack_require__(17);
